...
class EtsyApiShopSource(ShopSource):
    ...
    move slowly, while the cost of a miss is a full request per shop. The
    cache is never invalidated - restart the app for fresh numbers. (Once
    Epic E's database lands, this cache is what becomes a `shops` table -
    see #26.)"""
    ...
    def __init__(self, api_key_provider: Callable[[], str],
        ...
        self._search_cache: dict[str, tuple[list[Shop], int]] = {}
