...
import type { ListingFilter } from "../listings/types";
...
export function ShopDetailView({ shop, onBack, onToggleTracked }: ShopDetailViewProps) {
  ...
  // No onSelectListing: a shop's listings are generated by buildShopDetail
  // with ids like "ct-l0", but ListingDetailPage now resolves against the
  // live backend, where /api/listings/ct-l0 doesn't match the <int:lid>
  // route — Flask answers its own HTML 404 and the user is told to restart
  // a server that is working fine. Restore it once this page is on a real
  // repository (#8), together with the rows becoming navigable.
